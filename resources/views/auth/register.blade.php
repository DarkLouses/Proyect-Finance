    ...
    <div class="flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                <h1 class="text-3xl font-semibold mb-6 text-black text-center">Registrarse</h1>
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="email" name="name" value="{{ old('name') }}" required autocomplete="name"
                               autofocus
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Constraseña</label>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">Confirmar
                            constraseña</label>
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>Tienes Cuenta? <a href="{{ route('login') }}" class="text-black hover:underline">Iniciar
                            Seccion</a>
                    </p>
                </div>
            </div>
