        ...
        <div class="flex h-screen">
            ...
            <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                <div class="max-w-md w-full p-6">
                    <h1 class="text-3xl font-semibold mb-6 text-black text-center">Iniciar Seccion</h1>
                    <form method="POST" action="{{ route('login') }}" class="space-y-4">
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700">Constraseña</label>
                    ...
                    <div class="mt-4 text-sm text-gray-600 text-center">
                        <p> No tienes Cuenta?
                            <a href="{{ route('register') }}" class="text-black hover:underline">Crear
                                Cuenta
                            </a>
                        </p>
                    </div>
