                                    ...
                                    <div class="w-fit">
                                        ...
                                        <div class="m-auto mt-6">
                                            <label for="description" class="m-auto mt-3">Descripcion
                                                <input type="text" name="description" class="mt-1 p-2 w-full border rounded-md" value="{{ $expense->description }}">
                                            </label>
                                        </div>
                                        <div class="grid grid-cols-2 mt-6">
                                            <label for="amount" class="mr-2">Monto
                                                <input type="text" name="amount" class="mt-1 p-2 w-full border rounded-md" value="{{ $expense->amount }}">
                                            </label>
                                            <label for="date">Fecha
                                                <input type="datetime-local" name="date" class="mt-1 p-2 w-full border rounded-md" value="{{ $expense->date }}">
                                            </label>
                                        </div>
                                        <div class="mt-6">
