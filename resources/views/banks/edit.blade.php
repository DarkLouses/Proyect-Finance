                    ...
                    <div class="flex mb-5">
                        <nav class="flex w-fit px-5 py-3 text-gray-900 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li class="inline-flex items-center">
                                    <a href="{{ route('banks.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 ">Bancos</a>
                                </li>
                                    ...
                                    <div class="w-fit">
                                        <div class="m-auto mt-3">
                                            <label for="name" class="m-auto mt-3">name
                                                <input type="text" name="name" class="mt-1 p-2 w-full border rounded-md" value="{{ $bank->name }}" autofocus>
                                            </label>
                                        </div>
                                        <div class="m-auto mt-6">
                                            <label for="account_number" class="mr-2">Numero de cuenta
                                                <input type="text" name="account_number" class="mt-1 p-2 w-full border rounded-md" value="{{ $bank->account_number }}">
                                            </label>
                                        </div>
                                        <div class="grid grid-cols-2 mt-6">
                                            ...
                                            <label for="balance" >Balance
                                                <input type="text" name="balance" class="mt-1 p-2 w-full border rounded-md" value="{{ $bank->balance }}">
                                            </label>
                                        </div>
                                        <div class="mt-6">
