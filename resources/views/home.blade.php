                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{number_format($total_balance, 2, '.', ',')}} $</span>
                                    <h3 class="text-base font-normal text-gray-500">Balance este mes</h3>
                                </div>
                                <div
                                    class="flex items-center justify-center flex-auto text-green-800 text-base font-bold ">
                                    <button
                                        class="bg-blue-900 hover:bg-blue-300 text-white font-bold py-2 px-4 rounded mr-2.5">
                                        Todos
                                    </button>
                                    @forelse ($banks as $bank)
                                        <button
                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2.5">
                                            {{$bank->name}}
                                        </button>
                                    @empty
                                ...
                                <div class="flex items-center justify-end flex-1 text-green-800 text-base font-bold">
                                    12.5%
                                ...
                                <div class="overflow-x-auto rounded-lg">
                                    <div class="align-middle inline-block min-w-full">
                                        <div class="shadow overflow-hidden sm:rounded-lg ">
                                            <div
                                                class="flex items-center justify-center flex-auto text-green-800 text-base font-bold m-2" ">
                                                <button
                                                    class="bg-red-900 hover:bg-blue-300 text-white font-bold py-2 px-4 rounded mr-2.5">
                                                    Ver gasto
                                                </button>
                                                <button
                                                    class="bg-green-900 hover:bg-blue-300 text-white font-bold py-2 px-4 rounded mr-2.5">
                                                    Ver ingreso
                                                </button>
                                            </div>
                    ...
                    <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="flex items-center">
                                ...
                                <div
                                    class="ml-5 w-0 flex items-center justify-end flex-1 text-green-800 text-base font-bold">
                                    14.6%
                                    <i class="fa-solid fa-arrow-up"></i>
                                </div>
                            </div>
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            ...
                            <div class="block w-full overflow-x-auto">
                                <table class="items-center w-full bg-transparent border-collapse">
                                    <thead>
                                    <tr>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left border-l-0 border-r-0 whitespace-nowrap">
                                            Categorias
                                        </th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left border-l-0 border-r-0 whitespace-nowrap">
                                            Gastado
